...
listfollowing = []
print ("usuarios a los que sigue")
for user in db.Users2.find({ "username": "rsoaper3@adobe.com" }):
    listfollowing=user['following']
    #print (user['following'])

#print (listfollowing[0])
#print(listfollowing[0]['username'])

for i in listfollowing:
    print(listfollowing[i]['username'])
